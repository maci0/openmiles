...
comptime {
    ...
    if (is_x86_windows) {
        ...
        const targets = [_]Target{
            ...
            .{ .name = "AIL_open_XMIDI_driver", .stack_size = 4, .ver = 61 },
            .{ .name = "AIL_close_XMIDI_driver", .stack_size = 4, .ver = 61 },
            ...
            .{ .name = "AIL_DLS_load_file", .stack_size = 12, .ver = 50 },
            ...
            .{ .name = "AIL_set_stream_volume_pan", .stack_size = 12, .ver = 65, .ver_max = 69 },
            ...
            .{ .name = "RIB_provider_library_handle", .stack_size = 0, .ver = 50, .ver_max = 69 },
            ...
            .{ .name = "AIL_filter_attribute", .stack_size = 12, .ver = 61, .ver_max = 79 },
            .{ .name = "AIL_set_filter_attribute", .stack_size = 12, .ver = 60 },
            .{ .name = "AIL_enumerate_filters", .stack_size = 12, .ver = 61 },
            .{ .name = "AIL_enumerate_3D_providers", .stack_size = 12, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_allocate_3D_sample_handle", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_release_3D_sample_handle", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_file", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_position", .stack_size = 16, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_velocity", .stack_size = 20, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_orientation", .stack_size = 28, .ver = 50, .ver_max = 69 },
            ...
            .{ .name = "AIL_quick_load_mem", .stack_size = 8, .ver = 50 },
            ...
            .{ .name = "AIL_quick_ms_length", .stack_size = 4, .ver = 50 },
            .{ .name = "AIL_quick_ms_position", .stack_size = 4, .ver = 50 },
            .{ .name = "AIL_quick_set_ms_position", .stack_size = 8, .ver = 50 },
            ...
            // 3D Sample control
            .{ .name = "AIL_start_3D_sample", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_stop_3D_sample", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_resume_3D_sample", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_end_3D_sample", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_status", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_volume", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_volume", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_loop_count", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_loop_count", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_playback_rate", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_playback_rate", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_offset", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_offset", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_length", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_ms_position", .stack_size = 12, .ver = 50 },
            .{ .name = "AIL_set_3D_sample_ms_position", .stack_size = 8, .ver = 50 },
            .{ .name = "AIL_register_3D_EOS_callback", .stack_size = 8, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_active_3D_sample_count", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_user_data", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_user_data", .stack_size = 12, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_info", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_loop_block", .stack_size = 12, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_cone", .stack_size = 16, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_cone", .stack_size = 16, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_effects_level", .stack_size = 8, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_effects_level", .stack_size = 4, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_obstruction", .stack_size = 8, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_obstruction", .stack_size = 4, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_occlusion", .stack_size = 8, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_occlusion", .stack_size = 4, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_preference", .stack_size = 12, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_attribute", .stack_size = 12, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_auto_update_3D_position", .stack_size = 8, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_update_3D_position", .stack_size = 8, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_3D_velocity_vector", .stack_size = 16, .ver = 50, .ver_max = 69 },
            // 3D Environment
            ...
            .{ .name = "AIL_set_3D_room_type", .stack_size = 8, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_3D_room_type", .stack_size = 4, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_3D_speaker_type", .stack_size = 8, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_3D_speaker_type", .stack_size = 4, .ver = 61, .ver_max = 69 },
            // 3D Provider/Listener/Object
            .{ .name = "AIL_open_3D_provider", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_close_3D_provider", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_open_3D_listener", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_close_3D_listener", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_open_3D_object", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_close_3D_object", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_provider_attribute", .stack_size = 12, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_provider_preference", .stack_size = 12, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_enumerate_3D_provider_attributes", .stack_size = 12, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_enumerate_3D_sample_attributes", .stack_size = 12, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_orientation", .stack_size = 28, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_position", .stack_size = 16, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_velocity", .stack_size = 16, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_update_position", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_auto_update_position", .stack_size = 8, .ver = 50, .ver_max = 69 },
            ...
            // Sequence extras
            .{ .name = "AIL_sequence_ms_position", .stack_size = 12, .ver = 50 },
            .{ .name = "AIL_set_sequence_ms_position", .stack_size = 8, .ver = 50 },
            ...
            .{ .name = "AIL_sample_reverb", .stack_size = 16, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_sample_reverb", .stack_size = 16, .ver = 61, .ver_max = 69 },
            ...
            .{ .name = "AIL_stream_reverb", .stack_size = 16, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_stream_reverb", .stack_size = 16, .ver = 61, .ver_max = 69 },
            ...
            .{ .name = "AIL_set_stream_processor", .stack_size = 12, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_filter_stream_attribute", .stack_size = 12, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_filter_stream_preference", .stack_size = 12, .ver = 61, .ver_max = 69 },
            // Filter extras
            .{ .name = "AIL_enumerate_filter_attributes", .stack_size = 12, .ver = 61, .ver_max = 79 },
            .{ .name = "AIL_enumerate_filter_sample_attributes", .stack_size = 12, .ver = 61, .ver_max = 79 },
            .{ .name = "AIL_filter_sample_attribute", .stack_size = 12, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_filter_sample_preference", .stack_size = 12, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_filter_DLS_preference", .stack_size = 12, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_set_filter_preference", .stack_size = 12, .ver = 61, .ver_max = 79 },
            .{ .name = "AIL_filter_DLS_attribute", .stack_size = 12, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_filter_DLS_with_XMI", .stack_size = 24, .ver = 50 },
            // Quick API extras
            .{ .name = "AIL_quick_halt", .stack_size = 4, .ver = 30 },
            .{ .name = "AIL_quick_set_reverb", .stack_size = 16, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_quick_load_and_play", .stack_size = 12, .ver = 30 },
            .{ .name = "AIL_quick_type", .stack_size = 4, .ver = 50 },
            ...
            // DLS extras
            .{ .name = "AIL_DLS_load_memory", .stack_size = 12, .ver = 50 },
            .{ .name = "AIL_DLS_unload", .stack_size = 8, .ver = 50 },
            .{ .name = "AIL_DLS_compact", .stack_size = 4, .ver = 50 },
            .{ .name = "AIL_DLS_get_info", .stack_size = 12, .ver = 50 },
            .{ .name = "AIL_DLS_get_reverb", .stack_size = 16, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_DLS_set_reverb", .stack_size = 16, .ver = 61, .ver_max = 69 },
            .{ .name = "AIL_DLS_open", .stack_size = 28, .ver = 50 },
            .{ .name = "AIL_DLS_close", .stack_size = 8, .ver = 50 },
            // Redbook extras
            .{ .name = "AIL_redbook_eject", .stack_size = 4 },
            .{ .name = "AIL_redbook_retract", .stack_size = 4 },
            .{ .name = "AIL_redbook_id", .stack_size = 4 },
            .{ .name = "AIL_redbook_open_drive", .stack_size = 4, .ver = 50 },
            ...
            .{ .name = "AIL_set_DirectSound_HWND", .stack_size = 8, .ver = 50, .ver_max = 79 },
            ...
            .{ .name = "AIL_HWND", .stack_size = 0, .ver = 50, .ver_max = 79 },
            ...
            .{ .name = "AIL_set_file_async_callbacks", .stack_size = 20, .ver = 61, .ver_max = 89 },
            .{ .name = "AIL_set_DLS_processor", .stack_size = 12, .ver = 61, .ver_max = 69 },
            ...
            // DLS utilities
            .{ .name = "AIL_compress_DLS", .stack_size = 20, .ver = 50 },
            .{ .name = "AIL_extract_DLS", .stack_size = 28, .ver = 50 },
            .{ .name = "AIL_find_DLS", .stack_size = 24, .ver = 50 },
            .{ .name = "AIL_list_DLS", .stack_size = 20, .ver = 50 },
            .{ .name = "AIL_list_MIDI", .stack_size = 20, .ver = 50, .ver_max = 70 },
            .{ .name = "AIL_merge_DLS_with_XMI", .stack_size = 16, .ver = 50 },
            // Legacy DLS* functions (no AIL_ prefix)
            .{ .name = "DLSClose", .stack_size = 8, .ver = 50, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSCompactMemory", .stack_size = 4, .ver = 50, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSGetInfo", .stack_size = 12, .ver = 50, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSLoadFile", .stack_size = 12, .ver = 50, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSLoadMemFile", .stack_size = 12, .ver = 50, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSMSSGetCPU", .stack_size = 4, .ver = 50 },
            .{ .name = "DLSMSSOpen", .stack_size = 28, .ver = 50, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSSetAttribute", .stack_size = 12, .ver = 50, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSUnloadAll", .stack_size = 4, .ver = 50, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSUnloadFile", .stack_size = 8, .ver = 50, .cdecl = true, .ver_max = 79 },
            // DLL entry point
            ...
            .{ .name = "AIL_redbook_set_volume_level", .stack_size = 8, .ver = 65 },
            .{ .name = "AIL_redbook_volume_level", .stack_size = 4, .ver = 65 },
            ...
            .{ .name = "AIL_quick_set_reverb_levels", .stack_size = 12, .ver = 65 },
            ...
            .{ .name = "AIL_quick_load_named_mem", .stack_size = 12, .ver = 70 },
