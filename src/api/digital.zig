...
comptime {
    ...
    if (is_x86_windows) {
        ...
        const targets = [_]Target{
            ...
            .{ .name = "AIL_set_stream_volume_pan", .stack_size = 12, .ver = 60 },
            ...
            .{ .name = "AIL_filter_attribute", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_set_filter_attribute", .stack_size = 12, .ver = 60 },
            .{ .name = "AIL_enumerate_filters", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_enumerate_3D_providers", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_allocate_3D_sample_handle", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_release_3D_sample_handle", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_set_3D_sample_file", .stack_size = 8, .ver = 40 },
            ...
            // 3D Sample control
            .{ .name = "AIL_start_3D_sample", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_stop_3D_sample", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_resume_3D_sample", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_end_3D_sample", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_3D_sample_status", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_3D_sample_volume", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_set_3D_sample_volume", .stack_size = 8, .ver = 40 },
            .{ .name = "AIL_3D_sample_loop_count", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_set_3D_sample_loop_count", .stack_size = 8, .ver = 40 },
            .{ .name = "AIL_3D_sample_playback_rate", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_set_3D_sample_playback_rate", .stack_size = 8, .ver = 40 },
            .{ .name = "AIL_3D_sample_offset", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_set_3D_sample_offset", .stack_size = 8, .ver = 40 },
            .{ .name = "AIL_3D_sample_length", .stack_size = 4, .ver = 40 },
            ...
            .{ .name = "AIL_active_3D_sample_count", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_3D_user_data", .stack_size = 8, .ver = 40 },
            .{ .name = "AIL_set_3D_user_data", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_set_3D_sample_info", .stack_size = 8, .ver = 40 },
            .{ .name = "AIL_set_3D_sample_loop_block", .stack_size = 12, .ver = 40 },
            ...
            .{ .name = "AIL_set_3D_sample_preference", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_3D_sample_attribute", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_auto_update_3D_position", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_update_3D_position", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_set_3D_velocity_vector", .stack_size = 16, .ver = 40 },
            // 3D Environment
            ...
            .{ .name = "AIL_open_3D_provider", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_close_3D_provider", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_open_3D_listener", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_close_3D_listener", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_open_3D_object", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_close_3D_object", .stack_size = 4, .ver = 40 },
            .{ .name = "AIL_3D_provider_attribute", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_set_3D_provider_preference", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_enumerate_3D_provider_attributes", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_enumerate_3D_sample_attributes", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_3D_orientation", .stack_size = 28, .ver = 40 },
            .{ .name = "AIL_3D_position", .stack_size = 16, .ver = 40 },
            .{ .name = "AIL_3D_velocity", .stack_size = 16, .ver = 40 },
            .{ .name = "AIL_3D_update_position", .stack_size = 8, .ver = 40 },
            .{ .name = "AIL_3D_auto_update_position", .stack_size = 8, .ver = 40 },
            ...
            .{ .name = "AIL_set_stream_processor", .stack_size = 12, .ver = 60 },
            .{ .name = "AIL_filter_stream_attribute", .stack_size = 12 },
            .{ .name = "AIL_set_filter_stream_preference", .stack_size = 12 },
            // Filter extras
            .{ .name = "AIL_enumerate_filter_attributes", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_enumerate_filter_sample_attributes", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_filter_sample_attribute", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_set_filter_sample_preference", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_set_filter_DLS_preference", .stack_size = 12 },
            .{ .name = "AIL_set_filter_preference", .stack_size = 12, .ver = 40 },
            ...
            .{ .name = "AIL_set_file_async_callbacks", .stack_size = 20, .ver = 60 },
            .{ .name = "AIL_set_DLS_processor", .stack_size = 12, .ver = 60 },
