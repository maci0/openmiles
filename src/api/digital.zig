...
comptime {
    ...
    if (is_x86_windows) {
        ...
        const targets = [_]Target{
            ...
            .{ .name = "MilesShutdownEventSystem", .stack_size = 0, .ver = 90 },
            ...
            .{ .name = "MilesEnqueueEvent", .stack_size = 24, .ver = 90 },
            .{ .name = "MilesEnqueueEventContext", .stack_size = 28, .ver = 90 },
            .{ .name = "MilesEnqueueEventByName", .stack_size = 4, .ver = 90 },
            .{ .name = "MilesBeginEventQueueProcessing", .stack_size = 0, .ver = 90 },
            .{ .name = "MilesCompleteEventQueueProcessing", .stack_size = 0, .ver = 90 },
            .{ .name = "MilesClearEventQueue", .stack_size = 0, .ver = 90 },
            .{ .name = "MilesStartSoundInstance", .stack_size = 32, .ver = 90 },
            .{ .name = "MilesStopSoundInstances", .stack_size = 12, .ver = 90 },
            .{ .name = "MilesPauseSoundInstances", .stack_size = 12, .ver = 90 },
            .{ .name = "MilesResumeSoundInstances", .stack_size = 12, .ver = 90 },
            ...
            .{ .name = "MilesReleaseSoundBank", .stack_size = 4, .ver = 90 },
            .{ .name = "MilesFindEvent", .stack_size = 8, .ver = 90 },
            .{ .name = "MilesGetEventLength", .stack_size = 4, .ver = 90 },
            .{ .name = "MilesTextDumpEventSystem", .stack_size = 0, .ver = 90 },
            .{ .name = "MilesRegisterRand", .stack_size = 4, .ver = 90 },
