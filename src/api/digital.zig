...
comptime {
    ...
    if (is_x86_windows) {
        ...
        const targets = [_]Target{
            ...
            .{ .name = "AIL_open_XMIDI_driver", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_close_XMIDI_driver", .stack_size = 4, .ver = 60 },
            ...
            .{ .name = "AIL_waveOutOpen", .stack_size = 16, .ver_max = 69 },
            .{ .name = "AIL_open_digital_driver", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_close_digital_driver", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_serve", .stack_size = 0 },
            .{ .name = "AIL_set_digital_master_volume", .stack_size = 8, .ver_max = 69 },
            .{ .name = "AIL_digital_master_volume", .stack_size = 4, .ver_max = 69 },
            ...
            .{ .name = "AIL_set_sample_type", .stack_size = 12, .ver_max = 69 },
            ...
            .{ .name = "AIL_sample_volume", .stack_size = 4, .ver_max = 69 },
            .{ .name = "AIL_sample_pan", .stack_size = 4, .ver_max = 69 },
            .{ .name = "AIL_sample_playback_rate", .stack_size = 4 },
            .{ .name = "AIL_set_sample_volume", .stack_size = 8, .ver_max = 69 },
            .{ .name = "AIL_set_sample_pan", .stack_size = 8, .ver_max = 69 },
            .{ .name = "AIL_set_sample_playback_rate", .stack_size = 8 },
            .{ .name = "AIL_set_sample_volume_pan", .stack_size = 12, .ver = 60 },
            ...
            .{ .name = "AIL_set_stream_volume", .stack_size = 8, .ver_max = 69 },
            ...
            .{ .name = "AIL_set_stream_playback_rate", .stack_size = 8, .ver_max = 69 },
            .{ .name = "AIL_set_stream_pan", .stack_size = 8, .ver_max = 69 },
            ...
            .{ .name = "AIL_set_stream_volume_pan", .stack_size = 12, .ver = 60, .ver_max = 69 },
            .{ .name = "AIL_set_stream_ms_position", .stack_size = 8 },
            .{ .name = "AIL_stream_status", .stack_size = 4 },
            .{ .name = "AIL_stream_playback_rate", .stack_size = 4, .ver_max = 69 },
            .{ .name = "AIL_stream_volume", .stack_size = 4, .ver_max = 69 },
            .{ .name = "AIL_stream_pan", .stack_size = 4, .ver_max = 69 },
            ...
            .{ .name = "RIB_provider_library_handle", .stack_size = 0, .ver = 40, .ver_max = 69 },
            ...
            .{ .name = "AIL_filter_attribute", .stack_size = 12, .ver = 40, .ver_max = 79 },
            .{ .name = "AIL_set_filter_attribute", .stack_size = 12, .ver = 60 },
            .{ .name = "AIL_enumerate_filters", .stack_size = 12, .ver = 40 },
            .{ .name = "AIL_enumerate_3D_providers", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_allocate_3D_sample_handle", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_release_3D_sample_handle", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_file", .stack_size = 8, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_position", .stack_size = 16, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_velocity", .stack_size = 20, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_orientation", .stack_size = 28, .ver = 40, .ver_max = 69 },
            ...
            .{ .name = "AIL_set_listener_3D_position", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_set_listener_3D_velocity", .stack_size = 20, .ver = 60 },
            .{ .name = "AIL_set_listener_3D_orientation", .stack_size = 28, .ver = 60 },
            ...
            // 3D Sample control
            .{ .name = "AIL_start_3D_sample", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_stop_3D_sample", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_resume_3D_sample", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_end_3D_sample", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_status", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_volume", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_volume", .stack_size = 8, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_loop_count", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_loop_count", .stack_size = 8, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_playback_rate", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_playback_rate", .stack_size = 8, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_offset", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_offset", .stack_size = 8, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_length", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_ms_position", .stack_size = 12, .ver = 50 },
            .{ .name = "AIL_set_3D_sample_ms_position", .stack_size = 8, .ver = 50 },
            .{ .name = "AIL_register_3D_EOS_callback", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_active_3D_sample_count", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_user_data", .stack_size = 8, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_user_data", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_info", .stack_size = 8, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_loop_block", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_cone", .stack_size = 16, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_cone", .stack_size = 16, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_effects_level", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_effects_level", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_obstruction", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_obstruction", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_occlusion", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_occlusion", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_sample_preference", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_sample_attribute", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_auto_update_3D_position", .stack_size = 8, .ver = 60, .ver_max = 69 },
            .{ .name = "AIL_update_3D_position", .stack_size = 8, .ver = 60, .ver_max = 69 },
            .{ .name = "AIL_set_3D_velocity_vector", .stack_size = 16, .ver = 40, .ver_max = 69 },
            // 3D Environment
            .{ .name = "AIL_set_3D_distance_factor", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_3D_distance_factor", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_set_3D_doppler_factor", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_3D_doppler_factor", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_set_3D_rolloff_factor", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_3D_rolloff_factor", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_set_3D_room_type", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_room_type", .stack_size = 4, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_set_3D_speaker_type", .stack_size = 8, .ver = 50, .ver_max = 69 },
            .{ .name = "AIL_3D_speaker_type", .stack_size = 4, .ver = 50, .ver_max = 69 },
            // 3D Provider/Listener/Object
            .{ .name = "AIL_open_3D_provider", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_close_3D_provider", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_open_3D_listener", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_close_3D_listener", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_open_3D_object", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_close_3D_object", .stack_size = 4, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_provider_attribute", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_3D_provider_preference", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_enumerate_3D_provider_attributes", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_enumerate_3D_sample_attributes", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_orientation", .stack_size = 28, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_position", .stack_size = 16, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_velocity", .stack_size = 16, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_update_position", .stack_size = 8, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_3D_auto_update_position", .stack_size = 8, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_get_DirectSound3D_info", .stack_size = 16, .ver_max = 39 },
            .{ .name = "AIL_set_direct_buffer_control", .stack_size = 8, .ver_max = 59 },
            ...
            .{ .name = "AIL_sample_reverb", .stack_size = 16, .ver_max = 69 },
            .{ .name = "AIL_set_sample_reverb", .stack_size = 16, .ver_max = 69 },
            ...
            .{ .name = "AIL_allocate_file_sample", .stack_size = 12, .ver_max = 69 },
            .{ .name = "AIL_load_sample_buffer", .stack_size = 16 },
            .{ .name = "AIL_sample_buffer_ready", .stack_size = 4, .ver_max = 79 },
            ...
            .{ .name = "AIL_stream_reverb", .stack_size = 16, .ver_max = 69 },
            .{ .name = "AIL_set_stream_reverb", .stack_size = 16, .ver_max = 69 },
            .{ .name = "AIL_stream_info", .stack_size = 20 },
            .{ .name = "AIL_set_stream_loop_block", .stack_size = 12 },
            .{ .name = "AIL_service_stream", .stack_size = 8 },
            .{ .name = "AIL_register_EOF_callback", .stack_size = 8, .ver_max = 69 },
            .{ .name = "AIL_set_stream_processor", .stack_size = 12, .ver = 60, .ver_max = 69 },
            .{ .name = "AIL_filter_stream_attribute", .stack_size = 12, .ver_max = 69 },
            .{ .name = "AIL_set_filter_stream_preference", .stack_size = 12, .ver_max = 69 },
            // Filter extras
            .{ .name = "AIL_enumerate_filter_attributes", .stack_size = 12, .ver = 40, .ver_max = 79 },
            .{ .name = "AIL_enumerate_filter_sample_attributes", .stack_size = 12, .ver = 40, .ver_max = 79 },
            .{ .name = "AIL_filter_sample_attribute", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_filter_sample_preference", .stack_size = 12, .ver = 40, .ver_max = 69 },
            .{ .name = "AIL_set_filter_DLS_preference", .stack_size = 12, .ver_max = 69 },
            .{ .name = "AIL_set_filter_preference", .stack_size = 12, .ver = 40, .ver_max = 79 },
            .{ .name = "AIL_filter_DLS_attribute", .stack_size = 12, .ver_max = 69 },
            .{ .name = "AIL_filter_DLS_with_XMI", .stack_size = 24 },
            // Quick API extras
            .{ .name = "AIL_quick_halt", .stack_size = 4, .ver = 30 },
            .{ .name = "AIL_quick_set_reverb", .stack_size = 16, .ver = 40, .ver_max = 69 },
            ...
            .{ .name = "AIL_DLS_get_reverb", .stack_size = 16, .ver_max = 69 },
            .{ .name = "AIL_DLS_set_reverb", .stack_size = 16, .ver_max = 69 },
            ...
            .{ .name = "AIL_redbook_set_volume", .stack_size = 8, .ver_max = 69 },
            .{ .name = "AIL_redbook_volume", .stack_size = 4, .ver_max = 69 },
            // RIB extras
            ...
            .{ .name = "RIB_find_file_dec_provider", .stack_size = 20, .ver = 60 },
            ...
            .{ .name = "AIL_get_DirectSound_info", .stack_size = 12, .ver_max = 79 },
            .{ .name = "AIL_set_DirectSound_HWND", .stack_size = 8, .ver_max = 79 },
            ...
            .{ .name = "AIL_delay", .stack_size = 4, .ver_max = 89 },
            .{ .name = "AIL_lock", .stack_size = 0, .ver_max = 89 },
            .{ .name = "AIL_unlock", .stack_size = 0, .ver_max = 89 },
            ...
            .{ .name = "AIL_HWND", .stack_size = 0, .ver_max = 79 },
            .{ .name = "AIL_set_error", .stack_size = 4 },
            .{ .name = "AIL_get_timer_highest_delay", .stack_size = 0 },
            .{ .name = "AIL_set_timer_divisor", .stack_size = 8, .ver_max = 89 },
            ...
            .{ .name = "AIL_mem_use_malloc", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_mem_use_free", .stack_size = 4, .ver = 60 },
            ...
            .{ .name = "AIL_get_input_info", .stack_size = 4, .ver = 60, .symbol = "AIL_input_info" },
            .{ .name = "AIL_set_file_callbacks", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_set_file_async_callbacks", .stack_size = 20, .ver = 60, .ver_max = 89 },
            .{ .name = "AIL_set_DLS_processor", .stack_size = 12, .ver = 60, .ver_max = 69 },
            .{ .name = "AIL_create_wave_synthesizer", .stack_size = 16 },
            .{ .name = "AIL_destroy_wave_synthesizer", .stack_size = 4 },
            .{ .name = "AIL_waveOutClose", .stack_size = 4, .ver_max = 69 },
            ...
            .{ .name = "DLSClose", .stack_size = 8, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSCompactMemory", .stack_size = 4, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSGetInfo", .stack_size = 12, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSLoadFile", .stack_size = 12, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSLoadMemFile", .stack_size = 12, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSMSSGetCPU", .stack_size = 4 },
            .{ .name = "DLSMSSOpen", .stack_size = 28, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSSetAttribute", .stack_size = 12, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSUnloadAll", .stack_size = 4, .cdecl = true, .ver_max = 79 },
            .{ .name = "DLSUnloadFile", .stack_size = 8, .cdecl = true, .ver_max = 79 },
            // DLL entry point
            .{ .name = "DllMain", .stack_size = 12, .ver_max = 79 },
            .{ .name = "AIL_set_sample_3D_position", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_set_sample_3D_velocity", .stack_size = 20, .ver = 60 },
            .{ .name = "AIL_set_sample_3D_velocity_vector", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_set_sample_3D_orientation", .stack_size = 28, .ver = 60 },
            .{ .name = "AIL_set_sample_3D_cone", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_set_sample_3D_distances", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_update_sample_3D_position", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_sample_3D_position", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_sample_3D_velocity", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_sample_3D_orientation", .stack_size = 28, .ver = 60 },
            .{ .name = "AIL_sample_3D_cone", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_sample_3D_distances", .stack_size = 16, .ver = 60 },
            ...
            .{ .name = "AIL_set_sample_obstruction", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_sample_obstruction", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_set_sample_occlusion", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_sample_occlusion", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_set_sample_exclusion", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_sample_exclusion", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_listener_3D_position", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_listener_3D_velocity", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_listener_3D_orientation", .stack_size = 28, .ver = 60 },
            .{ .name = "AIL_set_listener_3D_velocity_vector", .stack_size = 16, .ver = 60 },
            .{ .name = "AIL_update_listener_3D_position", .stack_size = 8, .ver = 60 },
            ...
            .{ .name = "AIL_background_CPU_percent", .stack_size = 0, .ver = 60 },
            .{ .name = "AIL_sample_processor", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_digital_driver_processor", .stack_size = 8, .ver = 60 },
            ...
            .{ .name = "AIL_speaker_configuration", .stack_size = 20, .ver = 60 },
            .{ .name = "AIL_set_speaker_configuration", .stack_size = 16, .ver = 60 },
            ...
            .{ .name = "AIL_enumerate_filter_properties", .stack_size = 12, .ver = 60 },
            .{ .name = "AIL_enumerate_filter_sample_properties", .stack_size = 12, .ver = 60 },
            .{ .name = "AIL_enumerate_output_filter_driver_properties", .stack_size = 12, .ver = 60 },
            .{ .name = "AIL_enumerate_output_filter_sample_properties", .stack_size = 12, .ver = 60 },
            .{ .name = "AIL_enumerate_sample_stage_properties", .stack_size = 16, .ver = 60 },
            ...
            .{ .name = "AIL_sample_buffer_count", .stack_size = 4, .ver = 60 },
            .{ .name = "AIL_sample_channel_count", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_sample_loop_block", .stack_size = 12, .ver = 60 },
            .{ .name = "AIL_sample_output_levels", .stack_size = 20, .ver = 60 },
            ...
            .{ .name = "AIL_set_sample_is_3D", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_set_sample_playback_delay", .stack_size = 8, .ver = 80 },
            .{ .name = "AIL_set_sample_playback_rate_factor", .stack_size = 8, .ver = 60 },
            .{ .name = "AIL_set_sample_speaker_scale_factors", .stack_size = 16, .ver = 60 },
            ...
            .{ .name = "AIL_IO_thread_handle", .stack_size = 4, .ver = 80 },
            ...
            .{ .name = "AIL_configure_logging", .stack_size = 12, .ver = 80 },
            .{ .name = "AIL_file_callbacks", .stack_size = 16, .ver = 80 },
            .{ .name = "AIL_file_read_info", .stack_size = 16, .ver = 80 },
            .{ .name = "AIL_file_size_info", .stack_size = 12, .ver = 80 },
            ...
            .{ .name = "AIL_get_time", .stack_size = 0, .ver = 80 },
            .{ .name = "AIL_mem_alloc_lock_info", .stack_size = 12, .ver = 80 },
            .{ .name = "AIL_ms_count64", .stack_size = 0, .ver = 80 },
            .{ .name = "AIL_ms_to_time", .stack_size = 8, .ver = 80 },
            .{ .name = "AIL_resolve_raw_environment_preset", .stack_size = 8, .ver = 90 },
            .{ .name = "AIL_resolve_raw_sound_preset", .stack_size = 12, .ver = 90 },
            .{ .name = "AIL_sample_loaded_len", .stack_size = 4, .ver = 80 },
            .{ .name = "AIL_sample_ms_lookup", .stack_size = 12, .ver = 90 },
            .{ .name = "AIL_sleep", .stack_size = 4, .ver = 80 },
            .{ .name = "AIL_sound_asset_info", .stack_size = 16, .ver = 90 },
            .{ .name = "AIL_stream_filled_percent", .stack_size = 4, .ver = 80 },
            .{ .name = "AIL_time_to_ms", .stack_size = 8, .ver = 80 },
            .{ .name = "AIL_timer_thread_handle", .stack_size = 4, .ver = 80 },
            .{ .name = "AIL_unapply_raw_environment_preset", .stack_size = 8, .ver = 80 },
            .{ .name = "AIL_unapply_raw_sound_preset", .stack_size = 8, .ver = 80 },
            .{ .name = "AIL_us_count64", .stack_size = 0, .ver = 80 },
            ...
            .{ .name = "MilesUseTelemetry", .stack_size = 4, .ver = 80 },
            .{ .name = "MilesUseTmLite", .stack_size = 4, .ver = 80 },
            .{ .name = "MilesAsyncStartup", .stack_size = 0, .ver = 80 },
            .{ .name = "MilesAsyncShutdown", .stack_size = 0, .ver = 80 },
            .{ .name = "MilesAsyncFileRead", .stack_size = 4, .ver = 80 },
            .{ .name = "MilesAsyncFileCancel", .stack_size = 4, .ver = 80 },
            .{ .name = "MilesAsyncFileStatus", .stack_size = 8, .ver = 80 },
