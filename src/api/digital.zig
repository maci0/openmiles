...
comptime {
    ...
    if (is_x86_windows) {
        ...
        const targets = [_]Target{
            ...
            .{ .name = "AIL_add_control_sounds_event_step", .stack_size = 36, .ver = 80, .ver_max = 80, .symbol = "AIL_add_control_sounds_event_step_v8" },
            ...
            .{ .name = "AIL_add_start_sound_event_step", .stack_size = 84, .ver = 80, .ver_max = 80, .symbol = "AIL_add_start_sound_event_step_v8" },
            ...
            .{ .name = "MilesStartupEventSystem", .stack_size = 16, .ver = 90 },
            .{ .name = "MilesStartupEventSystem", .stack_size = 20, .ver = 80, .ver_max = 80, .symbol = "MilesStartupEventSystem_v8" },
            ...
            .{ .name = "MilesSetEventErrorCallback", .stack_size = 4, .ver = 90 },
            .{ .name = "MilesEventSetAuditionFunctions", .stack_size = 4, .ver = 90 },
            .{ .name = "MilesGetBankFunctions", .stack_size = 0, .ver = 90 },
            .{ .name = "MilesSetBankFunctions", .stack_size = 4, .ver = 90 },
