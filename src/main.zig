...
comptime {
    ...
    if (is_x86_windows) {
        ...
        const mods = .{
            @import("api/digital.zig"), @import("api/3d.zig"),      @import("api/stream.zig"),
            @import("api/quick.zig"),   @import("api/redbook.zig"), @import("api/timer.zig"),
            @import("api/file.zig"),    @import("api/input.zig"),   @import("api/midi.zig"),
            @import("api/dls.zig"),     @import("api/rib.zig"),     @import("api/filter.zig"),
            @import("api/memory.zig"),  @import("api/v7.zig"),      @import("api/v8.zig"),
            @import("api/v9.zig"),      @import("api/miles.zig"),   @import("api/legacy.zig"),
        };
